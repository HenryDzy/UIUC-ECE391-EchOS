...
void IDT_init(){
    ...
    SET_IDT_ENTRY(idt[0x01], link_handler_DB, 0);               // if we do not set reserved4=0, then it is a trap gate
    ...
    SET_IDT_ENTRY(idt[0x80], system_call,3);          //system calls in 3(user level)
