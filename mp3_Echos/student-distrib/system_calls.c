...
void print_helper_page(){
    printf("\nHelper Page for 391OS by Group 06\n");
    printf("This is a simple OS of UIUC ECE391 Course Project\n\n");
    printf("About this OS:\n");
    printf("Author: Group 06\n");
    printf("Member: ZX, ZY, HG, DX\n");
    printf("Version: 1.0 in FA23\n");
    printf("(C)Copyright 2023-2024 Group 06 && ECE391. All Rights Reserved.)\n\n");
    printf("Important Commands:\n");
    printf("help:                   print the helper page\n");
