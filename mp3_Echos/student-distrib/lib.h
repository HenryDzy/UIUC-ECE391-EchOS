...
extern void change_ATTRIB_FOR_COVER(uint8_t attrib, int x, int y);
extern void change_ATTRIB_FOR_COVER_BACK();
extern void build_hwcontext(uint32_t* ret_addr_ptr, int32_t* signum_ptr, hardware_context_t* hwcontext, uint32_t ret_handler_size);
